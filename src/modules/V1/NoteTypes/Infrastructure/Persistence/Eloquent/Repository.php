...
use Modules\V1\NoteTypes\Domain\IModuleRepository;
use Modules\V1\NoteTypes\Infrastructure\Persistence\Eloquent\Model;
...
class Repository implements IModuleRepository {
   ...
   * @param array $where
   * @param array $options
   * @return Modules\V1\NoteTypes\Infrastructure\Persistence\Eloquent\Model
   */
   ...
   * @param array $data
   * @return Modules\V1\NoteTypes\Infrastructure\Persistence\Eloquent\Model|Modules\V1\Users\Infrastructure\Persistence\Eloquent\Model[]
   */
