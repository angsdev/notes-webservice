        ...
        <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
          ...
          <div class="flex justify-center">
            <svg class="w-32 h-32" viewBox="0 0 50 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <linearGradient id="paint0_linear" x1="16.9996" y1="10.4791" x2="47.0156" y2="10.4791" gradientUnits="userSpaceOnUse">
          ...
          <div class="mt-4">
            <a class="px-2 py-2 text-blue-200 bg-blue-600 rounded" href="${process.env.SERVER_HOST}:${process.env.SERVER_PORT}/${data.version}/auth/password/reset/${data.token}" target="_blank">Click to Reset Password</a>
            <p class="mt-4 text-sm">
              If you’re having trouble clicking the "Reset Password" button, copy and paste the URL below into your web browser:
              <a href="#" class="text-blue-600">${process.env.SERVER_HOST}:${process.env.SERVER_PORT}/${data.version}/auth/password/reset/${data.token}</a>
            </p>
          </div>
        </div>
      </div>
