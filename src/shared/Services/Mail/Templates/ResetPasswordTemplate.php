      ...
      <body>
        <div class='flex items-center justify-center min-h-screen p-5 bg-gray-600 min-w-screen'>
          <div class='max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12'>
            <h3 class='text-2xl'>Password reset for {$appName}</h3>
            ...
            <div class='mt-4'>
              <a class='px-2 py-2 text-blue-200 bg-blue-600 rounded' href='{$appHost}/{$version}/auth/password/reset/{$token}' target='_blank'>Click to Reset Password</a>
